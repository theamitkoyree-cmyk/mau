...
def main(page: ft.Page):
    ...
    def show_profile():
        ...
        posts_view=[]
        if not posts:
            posts_view.append(ft.Container(padding=30, alignment=ft.alignment.center, content=ft.Column([ft.Icon(ft.Icons.CAMERA_ALT, color="grey", size=50), ft.Text("No Posts Yet", color="grey")], horizontal_alignment="center")))
        else:
            for p in posts:
    ...
    def show_register():
        ...
        uname = ft.TextField(label="Username", hint_text="apna naam likho", width=300, bgcolor="#121212", color="white", border_radius=12, border_color="#363636", focused_border_color="#d62976", prefix_icon=ft.Icons.PERSON_OUTLINE)
        pwd = ft.TextField(label="Password", hint_text="password", password=True, can_reveal_password=True, width=300, bgcolor="#121212", color="white", border_radius=12, border_color="#363636", focused_border_color="#d62976", prefix_icon=ft.Icons.LOCK_OUTLINE)
        ...
        register_card = ft.Container(
            ...
            content=ft.Column([
                ft.Container(alignment=ft.alignment.center, content=ft.Column([
                    ft.Container(width=70, height=70, border_radius=35, bgcolor="#d62976", alignment=ft.alignment.center, content=ft.Text("A", color="white", size=35, weight="bold")),
                ...
                ft.ElevatedButton("Register / Login", on_click=do_reg, width=300, height=48, bgcolor="#d62976", color="white", style=ft.ButtonStyle(shape=ft.RoundedRectangleBorder(radius=12), text_style=ft.TextStyle(size=16, weight="bold"))),
                ft.Container(height=10, content=ft.Row([ft.Divider(color="#262626"), ft.Text(" OR ", color="grey", size=11), ft.Divider(color="#262626")])),
